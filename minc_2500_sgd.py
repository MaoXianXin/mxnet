...
def parse_args():
    ...
    parser.add_argument('-j', '--num-data-workers', dest='num_workers', default=6, type=int,
    ...
    parser.add_argument('--lr-decay-epoch', type=str, default='50,100',
                        help='epochs at which learning rate decays. default is 50,100.')
...
def main():
    ...
    with net.name_scope():
        ...
        net.fc = nn.Dense(in_units=512 * 4, units=classes)
    # net.output.initialize(init.Xavier())
    net.fc.initialize(init.Xavier())
    ...
    def train(epochs, ctx):
        ...
        train_path = '/home/mao/Downloads/datasets/minc-2500/train'
        val_path = '/home/mao/Downloads/datasets/minc-2500/val'
        ...
        trainer = gluon.Trainer(net.collect_params(), sgd_optimizer)
        # trainer = gluon.Trainer(net.fc.collect_params(), sgd_optimizer)
        metric = mx.metric.Accuracy()
        ...
        for epoch in range(epochs):
            ...
            if val_acc > best_val_score:
                ...
                net.save_parameters('%s/%.4f-minc-2500-%s-%d-best.params'%(save_dir, best_val_score, model_name, epoch))

            logging.info('[Epoch %d] train=%f val=%f loss=%f time: %f' %
                (epoch, acc, val_acc, train_loss, time.time()-tic))

            if save_period and save_dir and (epoch + 1) % save_period == 0:
                net.save_parameters('%s/minc-2500-%s-%d.params'%(save_dir, model_name, epoch))

        if save_period and save_dir:
            net.save_parameters('%s/minc-2500-%s-%d.params'%(save_dir, model_name, epochs-1))
