...
def main():
    ...
    def train(epochs, ctx):
        ...
        train_path = '/home/mao/PycharmProjects/convolution-network-natural-scenes/dataset/natural-scenes/seg_train'
        val_path = '/home/mao/PycharmProjects/convolution-network-natural-scenes/dataset/natural-scenes/seg_test'
        ...
        for epoch in range(epochs):
            ...
            if val_acc > best_val_score:
                ...
                net.save_parameters('%s/%.4f-natural-scenes-%s-%d-best.params'%(save_dir, best_val_score, model_name, epoch))

            logging.info('[Epoch %d] train=%f val=%f loss=%f time: %f' %
                (epoch, acc, val_acc, train_loss, time.time()-tic))

            if save_period and save_dir and (epoch + 1) % save_period == 0:
                net.save_parameters('%s/natural-scenes-%s-%d.params'%(save_dir, model_name, epoch))

        if save_period and save_dir:
            net.save_parameters('%s/natural-scenes-%s-%d.params'%(save_dir, model_name, epochs-1))
